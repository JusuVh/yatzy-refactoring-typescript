...
describe('Chance', () => {
  it('scores sum of all dice', () => {
    ...
    assert.strictEqual(14, new Yatzy(1, 1, 3, 3, 6).chance());
    assert.strictEqual(21, new Yatzy(4, 5, 5, 6, 1).chance());
  });
});
...
describe('Ones', () => {
  it('score the sum of 1s', () => {
    ...
    assert.strictEqual(0, new Yatzy(3, 3, 3, 4, 5).ones());
  });
});
...
describe('Twos', () => {
  it('score the sum of 2s', () => {
    ...
    assert.strictEqual(4, new Yatzy(2, 3, 2, 5, 1).twos());
  });
});
...
describe('Fours', () => {
  it('score the sum of 4s', () => {
    ...
    assert.strictEqual(8, new Yatzy(1, 1, 2, 4, 4).fours());
  });
});
...
describe('One pair', () => {
  it('scores the sum of the highest pair', () => {
    ...
    assert.strictEqual(0, new Yatzy(1, 2, 3, 4, 5).onePair());
    assert.strictEqual(8, new Yatzy(3, 3, 3, 4, 4).onePair());
    assert.strictEqual(12, new Yatzy(1, 1, 6, 2, 6).onePair());
    assert.strictEqual(6, new Yatzy(3, 3, 3, 4, 1).onePair());
    assert.strictEqual(6, new Yatzy(3, 3, 3, 3, 1).onePair());
  });
});
...
describe('Two pairs', () => {
  it('scores the sum of the two pairs', () => {
    ...
    assert.strictEqual(8, new Yatzy(1, 1, 2, 3, 3).twoPairs());
    assert.strictEqual(0, new Yatzy(1, 1, 2, 3, 4).twoPairs());
    assert.strictEqual(6, new Yatzy(1, 1, 2, 2, 2).twoPairs());
    assert.strictEqual(0, new Yatzy(3, 3, 3, 3, 1).twoPairs());
  });
});
...
describe('Three of a kind', () => {
  it('scores the sum of the three of the kind', () => {
    ...
    assert.strictEqual(0, new Yatzy(3, 3, 4, 5, 6).threeOfAKind());
  });
});
...
describe('Four of a kind', () => {
  it('scores the sum of the four of the kind', () => {
    ...
    assert.strictEqual(8, new Yatzy(2, 2, 2, 2, 5).fourOfAKind());
    assert.strictEqual(0, new Yatzy(2, 2, 2, 5, 5).fourOfAKind());
    assert.strictEqual(8, new Yatzy(2, 2, 2, 2, 2).fourOfAKind());
  });
});
...
describe('Small straight', () => {
  it('scores 15', () => {
    ...
    assert.strictEqual(0, new Yatzy(1, 2, 3, 4, 6).smallStraight());
  });
});
...
describe('Full house', () => {
  it('scores the sum of the full house', () => {
    ...
    assert.strictEqual(8, new Yatzy(1, 1, 2, 2, 2).fullHouse());
    assert.strictEqual(0, new Yatzy(2, 2, 3, 3, 4).fullHouse());
    assert.strictEqual(0, new Yatzy(4, 4, 4, 4, 4).fullHouse());
    assert.strictEqual(14, new Yatzy(4, 1, 4, 1, 4).fullHouse());
  });
});
